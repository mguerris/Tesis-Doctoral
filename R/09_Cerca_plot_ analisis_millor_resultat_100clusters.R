...
#El mejor resultado se encuentra en Bestskm6000rep_100clusters.RData
save(bestskm,filename="Bestskm_100clusters.RData")
...
boxplot(vector_resul, horizontal = FALSE,
